...
public class RestricaoDAO {
    ...
    public void salvar (RestricaoBean restricoes) throws RestricaoDAOException, SQLException{
        ...
        try{
            ...
            String query = "insert into pacientexrestricao(codigo_paciente, codigo_restricao) values (?,?) ";            
    ...
    public void atualizar(RestricaoBean restricoes)  throws RestricaoDAOException, SQLException{ 
        try{ 
            ...
            String query = "UPDATE pacientexrestricao set codigo_paciente = ? where codigo_restricao = ?";
            this.con = getConexao();
    ...
    public List retornaRestricoes() throws SQLException, RestricaoDAOException{
        ...
        try{
            this.con = getConexao();
            String query = "select * from pacientexrestricao as pr inner join restricoes as re on pr.codigo_restricao = re.codigo_restricao "+
   ...
   public String ultimoRegistro() throws RestricaoDAOException, SQLException{
    ...
    public List codigoPaciente(int codigo) throws SQLException, RestricaoDAOException{
        ...
        try{
            this.con = getConexao();
            this.stmt = this.con.prepareStatement("select codigo_paciente from pacientexrestricao where codigo_restricao = ?");
