...
<ul class="nav nav-tabs">
  ...
  <li <% if (perfil.equalsIgnoreCase("paciente")){ %> class="active"<% } %> >
       ...
       <div class="control-group">
            ...
            <div class="controls">    
                <label class="checkbox inline">
                    <input type="radio" name="tipo-cadastro" id="proprio" value="proprio"> Próprio
                  </label>
                  <label class="checkbox inline">
                    <input type="radio" name="tipo-cadastro" id="responsavel" value="responsavel"> Responsável
                  </label>
            </div>
      </div>      
      <div class="control-group">
      ...
      <div class="control-group">
            ...
            <div class="controls">    
                <input type="text" value="<%=pessoaPrimeiroCadastro.getDataNascimento()%>" class="input-xlarge" placeholder="Digite seu CRM…" id="crm" name="crm" />
            </div>
       </div>
      <div class="control-group">
            <label class="control-label" for="nome">
      ...
      <% } %>
        <div class="control-group">
            <div class="controls">
                ...
                <input type="button" class="btn btn-danger" onclick="window.location = '/ProntuarioDigital' " value="Cancelar" />
            </div>
        </div>
    </fieldset>
    </form>    
